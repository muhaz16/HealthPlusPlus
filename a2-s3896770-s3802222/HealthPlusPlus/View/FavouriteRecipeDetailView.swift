//
//  FavouriteRecipeDetailView.swift
//  HealthPlusPlus
//
//  Created by Muhammad Hazren Rosdi on 28/9/2023.
//

import SwiftUI
import CoreData

/// Favorite Recipe Detail View displays the information about the selected Favourited ``Recipe``
struct FavouriteRecipeDetailView: View {
    ...
    /// Delete the ``recipe`` from the core data
    private func deleteRecipe() {
        ...
        do{
            ...
            // Delete all matching recipes
            for recipeToDelete in existingRecipes {
                ...
                HStack{
                    ...
                    Button(action:{
                        ...
                        Image(systemName: "trash")
                            .foregroundColor(isDelete ? .black : .red)
                    }
                    .alert(isPresented: $showAlert){
                        Alert(
                            title: Text(""),
                            message: Text("This recipe has deleted from the favourites"),
...
struct FavouriteRecipeDetailView_Previews: PreviewProvider {
    static var previews: some View {
        FavouriteRecipeDetailView(recipe: Recipe(
